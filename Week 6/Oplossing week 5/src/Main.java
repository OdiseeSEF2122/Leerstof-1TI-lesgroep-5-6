        ...
        while(true){
            ...
            if(input.equals("1")) {
               ...
               // String id = "" + docenten.size() + studenten.size();
                ...
                Integer id = school.addStudent(name, Integer.parseInt(age));

                if(id != null){
                    // indien de student nog niet bestaat, voeg de student toe aan de lijst
                    System.out.println("Student correct toegevoegd " + id);
                } else {
                ...
                if(school.addScore(idDocent, idStudent, vak, punt)){
